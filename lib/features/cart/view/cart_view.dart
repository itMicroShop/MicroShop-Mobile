                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'USH ${payableAmount(subTotal: subTotal, deliveryCharge: 0, couponDiscountAmount: couponDiscountAmount)}',
      ...
      child: Column(
        children: [
          CartSummaryText(
            ...
            subTitle: 'USH ${subTotal.toStringAsFixed(2)}',
          ),
          12.ph,
          CartSummaryText(
            title: S.of(context).discount,
            subTitle: '-USH ${discount.toStringAsFixed(2)}',
            isDicount: true,
          ),
          12.ph,
          AppCustomDivider(
          ...
          CartSummaryText(
            ...
            subTitle: 'USH ${payableAmount.toStringAsFixed(2)}',
            shouldBold: true,
          ),
        ],
      ),
